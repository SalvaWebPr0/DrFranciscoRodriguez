...
const SliderText = ({ title, titleDesc }) => {
  return (
    <div className="hidden lg:inline-block absolute top-0 left-0 pl-20 w-full h-full">
        <div className="mx-auto flex h-full flex-col gap-y-6 justify-center">
            <motion.h2 
            ...
            className="text-lg text-slate-100 w-1/2"
            >
                {titleDesc}
            </motion.p>
            <motion.div
